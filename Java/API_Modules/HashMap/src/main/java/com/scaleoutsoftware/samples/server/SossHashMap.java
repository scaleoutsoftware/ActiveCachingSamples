...
// SOSS object definition for an ApiModule
public class SossHashMap {
    // ...
    // Add class members.
    // ...
    ...
    public SossHashMap(String id) {
        exampleHashMap = new HashMap<String,String>();
        Id = id;
    }

    public String get(String key) {
        return exampleHashMap.get(key);
    }
